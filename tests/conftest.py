...
def test_cfg_base():
    ...
    return {
        ...
        "chem": {
            "ph": 7.4, "ph_delta": 2.0, "max_ti_iters": 1,
            "max_stereoisomers": 16, "include_atropisomers": True,
            "allow_pyramidal_N": False
        },
        "conformers": {"engine": "rdkit", "num_confs": 5, "rmsd_thresh": 0.5},
        "minimization": {
            "engine": "openmm", "forcefield_spec": "openff-2.2.0.offxml",
            "implicit_solvent": None, "max_steps": 200, "gradient": 0.01
        },
